    ...
    private SensorEventListener mSensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged( SensorEvent event ) {
            if( event.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR ){
                ...
                mPitch = (int) ( Math.toDegrees( SensorManager.getOrientation( rMat, orientation )[1] ) * 180 / Math.PI);
                mRoll = (int) ( Math.toDegrees( SensorManager.getOrientation( rMat, orientation )[2] )  * 180 / Math.PI);*/


                //float quaternion_w = qua[0];
                //float quaternion_x = qua[1];
                //float quaternion_y = qua[2];
                //float quaternion_z = qua[3];
               // mAzimuth = (float) qua[0];
                //mPitch = (float) qua[1];
                //mRoll = (float) qua[2];
                //mAzimuthText.setText(String.valueOf(quaternion_z));
                //mPitchText.setText(String.valueOf(quaternion_x));
                //mRollText.setText(String.valueOf(quaternion_y));
                //mWText.setText("Quaternion W:"+String.valueOf(quaternion_w));
